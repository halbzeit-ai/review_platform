...
@router.get("/projects/{project_id}/documents/{document_id}/slide-feedback")
async def get_slide_feedback(
    ...
    """Get all slide feedback for a specific project document"""
